...
@section('title')
    <title>{{config('title.cate_article_add')}}</title>
@endsection
@section('body')
    <!--面包屑导航 开始-->
    ...
    <div class="result_wrap">
        <form action="{{url('admin/article/cate/edit').'/'.$cate->id}}" method="post">
            <table class="add_tab">
                {{csrf_field()}}
                <tbody>
                {{--<tr>--}}
                ...
                <tr>
                    <th>关键词：</th>
                    <td>
                        <textarea name="cate_keywords" value="{{$cate->cate_keywords}}"></textarea>
                    </td>
                </tr>
                <tr>
                    <th>描述：</th>
